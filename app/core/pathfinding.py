...
from app.core.edge_weights import (
...
# Re-exported here too: these exceptions historically lived in this module,
# so `from app.core.pathfinding import RouteNotFoundError` keeps working.
__all__ = [
    "RouteNotFoundError",
    "MissingCoordinatesError",
    "InvalidEdgeWeightError",
